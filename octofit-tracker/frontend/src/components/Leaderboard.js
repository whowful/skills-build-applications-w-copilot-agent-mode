...
const getItemLabel = (item) => item.username || item.name || item.title || 'Unnamed leaderboard entry';
      ...
      <div className="card-body">
        ...
        <form className="row g-2 align-items-end mb-3" onSubmit={(event) => event.preventDefault()}>
          <div className="col-md-8">
            <label className="form-label fw-semibold" htmlFor="leaderboard-search">Search leaderboard</label>
            <input
