...
const getItemLabel = (item) => item.team_name || item.name || item.title || 'Unnamed team';
      ...
      <div className="card-body">
        ...
        <form className="row g-2 align-items-end mb-3" onSubmit={(event) => event.preventDefault()}>
          <div className="col-md-8">
            <label className="form-label fw-semibold" htmlFor="teams-search">Search teams</label>
            <input
              id="teams-search"
