...
const ACTIVITIES_ENDPOINT = process.env.REACT_APP_CODESPACE_NAME
...
const getItemLabel = (item) => item.name || item.title || item.username || 'Unnamed activity';
      ...
      <div className="card-body">
        ...
        <form className="row g-2 align-items-end mb-3" onSubmit={(event) => event.preventDefault()}>
          <div className="col-md-8">
            <label className="form-label fw-semibold" htmlFor="activities-search">Search activities</label>
            <input
